...
class AutoCADPrintSelector:
    ...
    def create_components(self):
        ...
        tk.Button(self.button_frame, text="载入位置", command=self.load_position).pack(side=tk.LEFT, padx=5)
        tk.Button(self.button_frame, text="开始打印", command=self.start_print).pack(side=tk.LEFT, padx=5)
